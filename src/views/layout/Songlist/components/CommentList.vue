...
<template>
  <div class="comment-wrapper">
    ...
    <div class="section-header">
      ...
      <span class="comment-count">{{ songlistCommentList.comments.length }}</span>
    </div>

    <div v-if="songlistCommentList">
      <div
        v-for="item in songlistCommentList.comments"
        :key="item.commentId"
        class="comment-item"
      >
        <!-- 用户信息 -->
      ...
      <!-- 加载更多 -->
      <div class="load-more">
        <span v-if="songlistCommentList.more">加载更多...</span>
